  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "5nJOkxro0KTaCb2cqODyOkjXNOf9_SYfKXtJ7F-dP9w",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "济南",
    ...
    },
    {
     // 想要发送的人的名字
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "plFZvAD01gdIVRADBNQyzrek8jNuvGc9WTs8Hsg8wPE",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "德州",
    ...
    },
    {
      ...
      name: "李晓琳",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oNCQI6BvQPoTwVEzrYZb8-hW2vPA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "MOJjFpFywRbQ4rco1AZiyQcOmo9uFeORZTnW-qlO13o",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "济南",
